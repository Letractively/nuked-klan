...
if ($active == 3 || $active == 4) {
	...
	while (list($dl_id, $titre, $date, $cat, $description) = mysql_fetch_array($sql)) {
		...
		echo "<b>" . $i . " . <a href=\"index.php?file=Download&amp;op=description&amp;dl_id=" . $dl_id . "\" title=\"" . $description . "\">" . $titre . "</a></b><br />\n";
	...
	while (list($tdl_id, $ttitre, $tcount, $tcat, $desc) = mysql_fetch_array($sql3)) {
		...
		echo "<b>" . $l . " . <a href=\"index.php?file=Download&amp;op=description&amp;dl_id=" . $tdl_id . "\" title=\"" . $desc . "\">" . $ttitre . "</a></b><br />\n";
