...
var arrayTablesInstall = new Array(
                            "action", "banned", "block", "calendar", "comment", "comment_mod", "config", "contact", "discussion", "downloads",
                            "downloads_cat", "erreursql", "forums", "forums_cat", "forums_messages", "forums_threads", "forums_rank",
                            "forums_reads", "forums_poll", "forums_options", "forums_vote", "gallery", "gallery_cat", "guestbook",
                            "liens", "liens_cat", "modules", "nbconnecte", "news", "news_cat", "notification", "sections",
                            "sections_cat", "sessions", "smilies", "sondage", "sondage_check", "sondage_data", "stats", "stats_visitor",
                            "suggest", "shoutbox", "team_rank", "tmpses", "userbox", "users", "vote"
                        );
var arrayTablesUpdate = new Array(
                            "table_action", "table_banned", "table_comment_mod", "table_contact", "table_discussion", "table_erreursql", "table_forums_reads",
                            "table_notification", "table_tmpses", "table_users", "table_smilies", "update_bbcode", "update_config", "update_pass",
